...
> **AUDIT (2026-07-06, code-verified):** COMPLETED — PlanetLayerProjectionProfile, LayerProjectionProfileResolver, VertexProvenance + tests. _(See the authority index in `vault/README.md`.)_
